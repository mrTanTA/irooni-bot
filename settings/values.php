...
لینک اتصال هوشمند (کلیک کنید): SUB-LINK
⁮⁮ ⁮⁮ ⁮⁮ ⁮⁮
",
    ...
    'start_message'=>'❤️‍🩹 سلااام به ربات ایرونی خوش اومدی 
    
اینترنت آزاد رو با ایرونی تجربه کنید!❤️

✅ تجربه بالاترین سرعت با کمترین هزینه
📡 مخصوص تمامی نت ها 
...
$buttonValues = [
    ...
    'cancel' => '😪 منصرف شدم بیخیال',
        'join_channel'=>"عضویت در کانال ایرونی",
    'have_joined'=>"عضو شدم ✅",
    'gift_volume_day'=>"🎯 هدیه حجم و زمان",
    'test_account'=>"🎁 دریافت کانفیگ تست",
